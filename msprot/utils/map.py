...
class Map(Universe):
	def __init__(self, structure, out=None, mapping=[], mapping_add=[], BB2CA=True):
		...
		# construct
		firstdata = self.add_availableCGAtoms()
	...
	def add_availableCGAtoms(self):
		...
		for resname in self.resnames:
			...
			if resname not in self.mapping.RESI.keys(): continue
