...
class MartinizeDMS:
    ...
    def __init__(self, dms, martini, output=None, epsilon_r=15.0, 
    ...
    def updateAtoms(self, universe, output):
        nbtypes = []
        ...
        for resname in self.resnames:
            ...
            for bond in bonds:
                ...
                for i1, i2 in zip(df1.index, df2.index):
                    ...
                    # type 2 constraint should not add exclusions
                    if len(bond) == 4:
                        # normal bond
    ...
    def updateVirtualSites3(self):
        for resname in self.resnames:
            vs3s = self.martini.martini['molecules'][resname]['virtual_sites3']
            for vs3 in vs3s:
                atom1 = vs3[0]
                atom2 = vs3[1]
                atom3 = vs3[2]
